...
- [ ] T2: Define the `GET /line-suggestions` zod-openapi query + response schemas — refs: AC-1.7, AC-2.3, AC-4.3 — deps: T1
...
- [ ] T3: Implement the suggestions repository query — refs: AC-2.1, AC-2.2, AC-2.4, AC-2.6, AC-4.1 — deps: T1
...
- [ ] T4: Implement the fold-merge, ranking and cap service — refs: AC-2.1, AC-2.2, AC-2.3, AC-2.5, AC-1.5 — deps: T1, T3
...
- [ ] T5: Wire the route, authz gate and registration — refs: AC-4.1, AC-4.2, AC-4.3 — deps: T2, T4
...
- [ ] T6: Integration tests for the endpoint against real Postgres — refs: AC-2.1, AC-2.2, AC-2.3, AC-2.4, AC-2.5, AC-2.6, AC-1.7, AC-4.1, AC-4.2, AC-4.3, AC-4.4 — deps: T5
...
- [ ] T7: Let `getJson` forward a `RequestInit` (additive) — refs: AC-5.2 — deps: none
...
- [ ] T8: Mirror the fold + implement query matching in the UI — refs: AC-1.4, AC-1.5, AC-2.1 — deps: T1
...
- [ ] T9: Implement the suggestions API client — refs: AC-5.2 — deps: T2, T7
...
- [ ] T10: Add the `components.motivoSuggest` copy namespace — refs: AC-5.7, AC-1.7 — deps: none
...
- [ ] T11: Build the `MotivoSuggestField` combobox — refs: AC-1.1, AC-1.2, AC-1.3, AC-1.5, AC-1.6, AC-1.7, AC-5.2, AC-5.3, AC-5.4, AC-5.5, AC-5.6 — deps: T8, T9, T10
...
- [ ] T12: Wire the field into `ExpenseLineComposer` — refs: AC-1.1, AC-1.8, AC-3.1, AC-3.2, AC-3.3, AC-3.4, AC-3.5, AC-3.6, AC-3.7, AC-5.3, AC-5.4 — deps: T11
...
- [ ] T13: Component tests for the composer + field behaviour — refs: AC-1.1, AC-1.2, AC-1.3, AC-1.5, AC-1.6, AC-1.7, AC-1.8, AC-3.1, AC-3.2, AC-3.3, AC-3.4, AC-3.5, AC-3.6, AC-3.7, AC-5.1, AC-5.2, AC-5.3, AC-5.4, AC-5.5, AC-5.6 — deps: T12
...
- [ ] T14: Port the no-hardcoded-strings guard to `refund-ui` — refs: AC-5.7 — deps: T10, T12
