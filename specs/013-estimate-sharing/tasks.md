...
- [x] T8: `GET` + `POST /estimates/{id}/collaborators` — the add path — refs: AC-1.1, AC-1.2, AC-1.3, AC-1.4, AC-1.5, AC-5.4 — deps: T6, T5
...
- [x] T18: `ConflictBanner` + the fourth save-status state — refs: AC-4.1, AC-4.2 — deps: T16, T17
...
- [x] T20: `CollaboratorsDialog` — owner mode — refs: AC-1.1, AC-1.2, AC-1.3, AC-1.4, AC-5.1, AC-5.2, AC-5.4 — deps: T15, T19
...
- [x] T23: Estimates list — shared indicator, owner identity, orphaned rows — refs: AC-2.1, AC-2.2, AC-2.3, AC-10.5, AC-10.4 — deps: T14, T15
