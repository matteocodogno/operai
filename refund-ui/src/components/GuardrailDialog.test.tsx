 ...
 *
 * Component tests for GuardrailDialog (T15, specs/007-refund-service,
 * design.md F2/F6 "409 → GuardrailDialog").
 *
 * Covers:
...
const baseProps = {
  ...
  message: 'This request has already been decided and can no longer be withdrawn.',
  onAcknowledge: vi.fn(),
}
