 ...
 *
 * Ported from estimai-ui/src/components/LogoMenu.test.tsx (T6, specs/003-suite-shell,
 * AC-1.4) — unchanged, since the relocated component is behaviorally identical.
 */
