    ...
    <div className="fixed inset-0 z-40 flex justify-end">
      ...
      <div className="relative z-10 w-[380px] h-full bg-ink-soft border-l border-rule shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6 text-xs text-soft">
          <section>
            ...
            <div className="flex flex-col gap-3">
              <div className="leading-relaxed">
                <strong className="text-acc-hi">PERT</strong> = (O + 4×ML + P) / 6
              </div>
              ...
              <div className="leading-relaxed">
                <strong>Expected</strong> = PERT + Risk Buffer
              </div>
              <div className="leading-relaxed">
                <strong>Individual M/D</strong> = Σ Expected + QA Deploy + QA Test + PM
              </div>
              <div className="leading-relaxed">
                <strong>Planning</strong> = FTE × (Individual / Sprint) / 8
              </div>
              <div className="leading-relaxed">
                <strong>Baseline</strong> = Individual + Planning
              </div>
              <div className="leading-relaxed">
                <strong>Elapsed Days</strong> = ROUND(Baseline × (1 − Parallel × (FTE−1) / FTE))
              </div>
              <div className="leading-relaxed">
                <strong>Total Man/Days</strong> = Elapsed × FTE
              </div>
              <div className="leading-relaxed">
                <strong>Months</strong> = Elapsed / Working days per month
              </div>
            </div>
          </section>
          ...
          <section>
            <h3 className="font-disp text-[12px] font-bold text-text uppercase tracking-[0.08em] mb-4">AI columns</h3>
            <div className="flex flex-col gap-3">
              <div className="leading-relaxed">
                <strong>AI-assisted days</strong> = Expected × (1 − AI Gain)
              </div>
              <div className="pl-3 py-1.5 border-l-2 border-acc/40 bg-[rgba(91,106,247,0.07)] rounded-r text-[11px] text-soft leading-relaxed">
                Resolved per activity (activity override → global default). Same pipeline applied for AI elapsed and
                total M/D.
              </div>
              <div className="leading-relaxed">
                <strong>AI Cost</strong> = Coefficient × FTE × Elapsed Days
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="flex flex-col gap-3">
              <div className="leading-relaxed">
                <strong>Best case</strong> = full chain on Optimistic estimates
              </div>
              <div className="leading-relaxed">
                <strong>Worst case</strong> = full chain on Pessimistic estimates
              </div>
              <div className="pl-3 py-1.5 border-l-2 border-acc/40 bg-[rgba(91,106,247,0.07)] rounded-r text-[11px] text-soft leading-relaxed">
          ...
          <section>
            <h3 className="font-disp text-[12px] font-bold text-text uppercase tracking-[0.08em] mb-4">Glossary</h3>
            <div className="flex flex-col gap-3">
              {(
                [
                  ...
                  [
                    'ai_gain',
                    'Fractional productivity improvement from AI tools (0–1). e.g. 0.30 = 30% effort reduction',
                  ],
                ] as const
              ).map(([term, def]) => (
